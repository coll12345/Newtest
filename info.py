...
API_ID = int(environ.get('API_ID', '20379905'))
API_HASH = environ.get('API_HASH', '98db0b65b098172e95c80eea258a7fb2')
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5036765942').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Dileep:Dileep@cluster0.gejzy.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
DOWNLOAD_TEXT_URL = "https://t.me/+3nWv_Jt-lIg4Y2Y1"
